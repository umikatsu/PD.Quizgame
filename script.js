document.addEventListener("DOMContentLoaded", () => {
    ...
    const quizzes = [
        ...
        {question: "災害後、「屋根の無料点検」「火災保険で修理できる」などと言って訪問してくる業者の対応として、最も適切な物はどれか？", choices: ["困っているため、すぐに修理契約書にサインする", "「点検だけは無料」と言われたため、とりあえず屋根に上がってもらう", "その場で契約はせず、身分証の確認、工務店や消費生活センターに相談する", "「保険金の請求代行を行う」と言われたため、手数料を前払いして任せる"], answer: "そのばで契約はせず、身分証の確認、工務店や消費生活センターに相談する", explanation: "すぐに契約書にサインしたり、屋根に上がってもらうことは悪質業者の手口のため、絶対に行ってはいけません。", images: []},
        {question: "「大希望水害対策」において最も重要とされる考え方として、国土交通省が提言しているものはどれか？", choices: ["すべての洪水は堤防工事で防げる", "施設の能力を超える大洪水は必ず発生すると考え、被害軽減を重視する", "小規模河川は洪水対策の対象内とする", "ハザードマップは大雨時以外でも更新する"], answer: "施設の能力を超える大洪水は必ず発生すると考え、被害軽減を重視する", explanation: "最近の水害対策では堤防や治水施設で防ぐ考え方を見直し、施設の限界を想定した被害軽減策が重要とされています。洪水対策の対象内とハザードマップについての記載は国土交通省が提言していません。", images: []},
