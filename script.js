document.addEventListener("DOMContentLoaded", () => {
    ...
    // quizImageはimageContainer内で動的に作成されるので、直接参照は不要
    // const quizImage = document.getElementById('quiz-image'); 
    const imageContainer = document.getElementById('quiz-image-container'); // 💡 imageContainerを直接取得
...
const quizzes = [
    ...
    // 💡 ブレーカー問題: 上に「kuizugamedetsukauyatsu.png」、下に「bureka.png」
    {question: "電気を復旧させるときの手順として正しい並び替えはどれか？ (画像参照)", 
      ...
      image: ["スクリーンショット 2025-11-14 150140.png", "bureka.png"] // 💡 順序変更
    }
];
    ...
    function displayQuiz() {
        ...
        // 画像コンテナの中身をクリア
        imageContainer.innerHTML = ''; // 💡 quizImageのIDがここで消えてしまうので、後で再設定する
